...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sentence-transformers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10366&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sentence-transformers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sentence-transformers` can be installed with:

```
conda install sentence-transformers
```

It is possible to list all of the versions of `sentence-transformers` available on your platform with:
